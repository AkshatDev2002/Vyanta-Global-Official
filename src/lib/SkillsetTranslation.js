export const skillsetTranslations = {
  en: {
    skillsetsTitle: "Our Skillsets",
    headerDescription:
      "With deep industry experience and a proven delivery track record, Vyanta Global's expert teams bring advanced capabilities across:",
    headerFooter:
      "Our in-depth domain knowledge and engineering excellence enable us to deliver scalable, secure, and reliable data-driven solutions, tailored to solve complex business challenges across diverse industries.",
    capabilities: [
      "Big Data Solutions",
    ...
    skillsets: [
      {
        ...
        description:
          "We deliver enterprise-grade big data solutions designed to process, manage, and analyze high-volume, high-velocity, and high-variety data with security, scalability, and cost efficiency at the core. We architect cloud-native big data platforms, modern data lakes and lakehouse ecosystems, and governed analytics frameworks that ensure data quality, regulatory compliance, and real-time insights. Our big data engineering services empower organizations to unlock actionable intelligence, support advanced analytics, and scale confidently while meeting global data governance and compliance standards.",
      },
      {
        title: "Data Integration Services",
        description:
          "Our expert data engineers provides enterprise-grade Data Integration Services that seamlessly connect disparate data sources, applications, and systems into a unified, analytics-ready ecosystem. We design and implement scalable ETL and ELT pipelines, real-time and batch data integration workflows, and API-driven data ingestion to ensure accurate, consistent, and reliable data movement across cloud and on-prem environments. Our data integration solutions enable faster decision-making, improved data quality, and governed, compliance-ready data flows that support modern analytics, business intelligence, and AI-driven use cases.",
      },
      {
  ...
  nl: {
    skillsetsTitle: "Onze Vaardigheden",
    headerDescription:
      "Met diepgaande brancheervaring en een bewezen track record levert Vyanta Global's expertteams geavanceerde mogelijkheden op:",
    headerFooter:
      "Onze diepgaande domeinkennis en engineering excellence stellen ons in staat om schaalbare, veilige en betrouwbare data-driven oplossingen op maat te leveren, afgestemd op het oplossen van complexe bedrijfsuitdagingen in diverse sectoren.",
    capabilities: [
    ...
    skillsets: [
      {
        title: "Big Data Solutions",
        description:
          "Wij leveren big data-oplossingen van ondernemingskwaliteit, speciaal ontworpen voor het verwerken, beheren en analyseren van grote hoeveelheden, hoge snelheid en grote verscheidenheid aan gegevens met veiligheid, schaalbaarheid en kostenefficiëntie als kernpunt. We ontwerpen cloud-native big data-platforms, moderne data lakes en lakehouse-ecosystemen, en beheerde analyseframeworks die gegevenskwaliteit, regelgevingsconformiteit en real-time inzichten garanderen. Onze big data engineering-services stellen organisaties in staat om bruikbare intelligentie vrij te maken, geavanceerde analyses te ondersteunen en vol vertrouwen te schalen, terwijl ze aan mondiale data governance- en compliancenormen voldoen.",
      },
      {
        title: "Data Integration Services",
        description:
          "Onze expert data engineers bieden gegevensintegratiediensten van ondernemingskwaliteit die heterogene gegevensbronnen, applicaties en systemen naadloos verbinden met een uniforme, analyserijke omgeving. We ontwerpen en implementeren schaalbare ETL- en ELT-pijplijnen, real-time en batch-gegevensintegratiewerkstromen, en API-gestuurde gegevensopname om nauwkeurige, consistente en betrouwbare gegevensbewegingen in cloud- en on-prem-omgevingen te garanderen. Onze gegevensintegratieoplossingen maken sneller besluitvorming, verbeterde gegevenskwaliteit en beheerde, compliancerijpe gegevensstromen mogelijk die moderne analyse, bedrijfsintelligentie en AI-gestuurde use cases ondersteunen.",
      },
      {
        title: "Data Governance & Compliance",
        description:
  ...
  fr: {
    skillsetsTitle: "Nos Compétences",
    headerDescription:
      "Avec une expérience sectorielle approfondie et un bilan de livraison prouvé, les équipes expertes de Vyanta Global apportent des capacités avancées dans :",
    headerFooter:
      "Notre connaissance approfondie du domaine et notre excellence en ingénierie nous permettent de fournir des solutions basées sur les données scalables, sécurisées et fiables, adaptées pour résoudre les défis commerciaux complexes dans diverses industries.",
    capabilities: [
      "Solutions Big Data",
    ...
    skillsets: [
      {
        title: "Big Data Solutions",
        description:
          "Nous fournissons des solutions big data de classe entreprise conçues pour traiter, gérer et analyser les données avec sécurité, scalabilité et efficacité des coûts au cœur. Nous construisons des plateformes big data cloud-native, des data lakes modernes et des écosystèmes lakehouse, et des cadres analytiques gouvernés qui assurent la qualité des données, la conformité réglementaire et les insights en temps réel. Nos services d'ingénierie big data permettent aux organisations de débloquer l'intelligence exploitable, de soutenir l'analyse avancée et de s'adapter en toute confiance tout en respectant les normes mondiales de gouvernance et de conformité des données.",
      },
      {
        title: "Data Integration Services",
        description:
          "Nos ingénieurs de données experts fournissent des services d'intégration de données d'entreprise qui connectent de manière transparente des sources de données, applications et systèmes disparates dans un écosystème unifié et prêt pour l'analyse. Nous concevons et implémentons des pipelines ETL et ELT scalables, des flux d'intégration de données en temps réel et par lots, et une ingestion de données basée sur les API pour assurer le mouvement des données précis, cohérent et fiable dans les environnements cloud et sur site. Nos solutions d'intégration de données permettent une prise de décision plus rapide, une qualité des données améliorée et des flux de données gouvernés et prêts pour la conformité qui soutiennent l'analyse moderne, le business intelligence et les cas d'usage basés sur l'IA.",
      },
      {
        title: "Data Governance & Compliance",
        description:
  ...
  de: {
    skillsetsTitle: "Unsere Fähigkeiten",
    headerDescription:
      "Mit tiefer Branchenerfahrung und nachgewiesener Leistungsbilanz bringen Vyanta Globals Expertenteams fortgeschrittene Fähigkeiten in:",
    headerFooter:
      "Unser tiefgreifendes Fachwissen und engineering-Exzellenz ermöglichen es uns, skalierbare, sichere und zuverlässige datengesteuerte Lösungen bereitzustellen, die auf komplexe Geschäftsprobleme in vielen Branchen zugeschnitten sind.",
    capabilities: [
      "Big-Data-Lösungen",
    ...
    skillsets: [
      {
        title: "Big Data Solutions",
        description:
          "Wir bieten Big-Data-Lösungen auf Unternehmensebene, die speziell für die Verarbeitung, Verwaltung und Analyse großer Datenmengen mit Sicherheit, Skalierbarkeit und Kosteneffizienz im Kern ausgelegt sind. Wir entwerfen Cloud-native Big-Data-Plattformen, moderne Data Lakes und Lakehouse-Ökosysteme sowie verwaltete Analyse-Frameworks, die Datenqualität, regulatorische Compliance und Echtzeit-Einblicke gewährleisten. Unsere Big-Data-Engineering-Services ermöglichen es Organisationen, umsetzbare Erkenntnisse freizusetzen, fortgeschrittene Analysen zu unterstützen und mit Zuversicht zu skalieren, während globale Daten-Governance- und Compliance-Standards erfüllt werden.",
      },
      {
        title: "Data Integration Services",
        description:
          "Unsere erfahrenen Datentechniker bieten Datenintegrationsdienste auf Unternehmensebene an, die unterschiedliche Datenquellen, Anwendungen und Systeme nahtlos in einem einheitlichen, analysegebrauchsfertigen Ökosystem verbinden. Wir entwerfen und implementieren skalierbare ETL- und ELT-Pipelines, Echtzeit- und Batch-Datenintegrations-Workflows und API-gesteuerte Datenerfassung, um eine genaue, konsistente und zuverlässige Datenbewegung in Cloud- und On-Premise-Umgebungen zu gewährleisten. Unsere Datenintegrationslösungen ermöglichen schnellere Entscheidungsfindung, verbesserte Datenqualität und verwaltete, compliance-bereite Datenflüsse, die moderne Analytics, Business Intelligence und AI-getriebene Anwendungsfälle unterstützen.",
      },
      {
        title: "Data Governance & Compliance",
        description:
  ...
  it: {
    skillsetsTitle: "Le Nostre Competenze",
    headerDescription:
      "Con profonda esperienza settoriale e un comprovato track record di consegna, i team di esperti di Vyanta Global portano capacità avanzate in:",
    headerFooter:
      "La nostra profonda conoscenza del dominio e l'eccellenza ingegneristica ci consentono di fornire soluzioni scalabili, sicure e affidabili basate sui dati, personalizzate per risolvere sfide aziendali complesse in diversi settori.",
    capabilities: [
      "Soluzioni Big Data",
    ...
    skillsets: [
      {
        title: "Big Data Solutions",
        description:
          "Forniamo soluzioni big data di classe enterprise progettate per elaborare, gestire e analizzare dati ad alto volume con sicurezza, scalabilità e efficienza dei costi al centro. Realizziamo piattaforme big data cloud-native, moderni data lake e ecosistemi lakehouse, e framework analitici governati che garantiscono qualità dei dati, conformità normativa e insight in tempo reale. I nostri servizi di ingegneria big data consentono alle organizzazioni di sbloccare intelligence utilizzabile, supportare analisi avanzate e scalare con fiducia rispettando gli standard globali di governance e conformità dei dati.",
      },
      {
        title: "Data Integration Services",
        description:
          "I nostri ingegneri di dati esperti forniscono servizi di integrazione dati di classe enterprise che connettono senza interruzioni diverse fonti di dati, applicazioni e sistemi in un ecosistema unificato e pronto per l'analisi. Progettiamo e implementiamo pipeline ETL e ELT scalabili, flussi di integrazione dati in tempo reale e batch, e acquisizione di dati guidata da API per garantire il movimento di dati accurato, coerente e affidabile in ambienti cloud e on-premise. Le nostre soluzioni di integrazione dati consentono un processo decisionale più rapido, una qualità dei dati migliorata e flussi di dati governati e pronti per la conformità che supportano analisi moderne, business intelligence e casi d'uso guidati dall'IA.",
      },
      {
        title: "Data Governance & Compliance",
        description:
  ...
  ru: {
    skillsetsTitle: "Наши Навыки",
    headerDescription:
      "Обладая глубоким опытом в отрасли и доказанной историей успешного выполнения проектов, команды экспертов Vyanta Global обладают передовыми возможностями в области:",
    headerFooter:
      "Наши глубокие знания в области и инженерное совершенство позволяют нам предоставлять масштабируемые, безопасные и надежные решения, основанные на данных, адаптированные для решения сложных бизнес-задач в различных отраслях.",
    capabilities: [
    ...
    skillsets: [
      {
        title: "Big Data Solutions",
        description:
          "Мы предоставляем решения больших данных корпоративного уровня, разработанные для обработки, управления и анализа больших объемов данных с безопасностью, масштабируемостью и экономической эффективностью в центре. Мы строим облачные платформы больших данных, современные озера данных и экосистемы озер-хранилищ, а также управляемые аналитические фреймворки, которые обеспечивают качество данных, соответствие нормативным требованиям и аналитику в реальном времени. Наши услуги инженерии больших данных позволяют организациям раскрыть полезную информацию, поддерживать продвинутую аналитику и уверенно масштабироваться, соответствуя глобальным стандартам управления и соответствия данных.",
      },
      {
        title: "Data Integration Services",
        description:
          "Наши опытные инженеры данных предоставляют услуги интеграции данных корпоративного уровня, которые беспрепятственно объединяют различные источники данных, приложения и системы в единую экосистему, готовую к аналитике. Мы проектируем и внедряем масштабируемые конвейеры ETL и ELT, рабочие процессы интеграции данных в реальном времени и пакетной обработке, а также приемы данных на основе API для обеспечения точного, согласованного и надежного перемещения данных в облачных и локальных средах. Наши решения интеграции данных обеспечивают более быстрое принятие решений, улучшенное качество данных и управляемые потоки данных, готовые к соответствию, которые поддерживают современную аналитику, бизнес-интеллект и случаи использования на основе искусственного интеллекта.",
      },
      {
        title: "Data Governance & Compliance",
        description:
  ...
  pt: {
    skillsetsTitle: "Nossas Habilidades",
    headerDescription:
      "Com profunda experiência do setor e um histórico comprovado de entrega, as equipes especializadas de Vyanta Global trazem capacidades avançadas em:",
    headerFooter:
      "Nosso conhecimento profundo de domínio e excelência em engenharia nos permitem fornecer soluções escaláveis, seguras e confiáveis orientadas por dados, adaptadas para resolver desafios comerciais complexos em diversos setores.",
    capabilities: [
    ...
    skillsets: [
      {
        title: "Big Data Solutions",
        description:
          "Fornecemos soluções de big data de nível corporativo projetadas para processar, gerenciar e analisar grandes volumes de dados com segurança, escalabilidade e eficiência de custos no centro. Construímos plataformas big data nativas em nuvem, data lakes modernos e ecossistemas de lakehouse, bem como estruturas analíticas governadas que garantem qualidade de dados, conformidade regulatória e insights em tempo real. Nossos serviços de engenharia de big data permitem que as organizações desbloqueiem inteligência acionável, suportem análises avançadas e escalam com confiança, atendendo aos padrões globais de governança e conformidade de dados.",
      },
      {
        title: "Data Integration Services",
        description:
          "Nossos engenheiros de dados experientes fornecem serviços de integração de dados de nível corporativo que conectam perfeitamente diversas fontes de dados, aplicações e sistemas em um ecossistema unificado e pronto para análise. Projetamos e implementamos pipelines ETL e ELT escaláveis, fluxos de integração de dados em tempo real e em lote, e ingestão de dados orientada por API para garantir movimento de dados preciso, consistente e confiável em ambientes em nuvem e no local. Nossas soluções de integração de dados permitem tomada de decisão mais rápida, qualidade de dados aprimorada e fluxos de dados governados e prontos para conformidade que suportam análise moderna, inteligência de negócios e casos de uso orientados por IA.",
      },
      {
        title: "Data Governance & Compliance",
        description:
